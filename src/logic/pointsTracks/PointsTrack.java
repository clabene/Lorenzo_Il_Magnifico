...
public abstract class PointsTrack implements Gainable, Serializable{
    ...
    * player just needs to have a PersonCardsPointsTrack attribute of type pointsTracks, that updates going ahead every time they
    * get a person card.
    *
    ...
    *
    * The decision of extending this class to all possible pointsTracks's was made in order
    ...
    * */
    ...
    public void setTrackPosition(LimitedInteger trackPosition) {
        this.trackPosition = trackPosition;
    }
    public void setTrackPosition(int position) {
        initializeTrackPosition(numberOfVictoryPointsOfPositions.length, position);
    }
