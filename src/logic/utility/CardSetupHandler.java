...
public class CardSetupHandler {
    ...
    public void  cardDescription() {
        ...
        ventureCards.add(new VentureCard("Sostegno al Vescovo", PeriodNumber.FIRST, new CardCost(new SetOfResources(new Wood(), new Stone(), new Money(2)), new MilitaryPointsTrack(2), 4), new ReceiveGainablesEffect(new FaithPointsTrack(1)), new ReceiveGainablesEffect(new VictoryPoint(1))));
...
//territorio primo periodo-----------------------------------------------------
        ...
        ventureCards.add(new VentureCard("Sostegno al Cardinale", PeriodNumber.SECOND, new CardCost(new SetOfResources(new Wood(2), new Stone(2), new Money(3)), new MilitaryPointsTrack(4), 7), new ReceiveGainablesEffect(new FaithPointsTrack(3)), new ReceiveGainablesEffect(new VictoryPoint(4))));
        ...
        ventureCards.add(new VentureCard("SOstegno al Papa", PeriodNumber.THIRD, new CardCost(new SetOfResources(new Money(4), new Stone(3), new Wood(3)), new MilitaryPointsTrack(5), 10), new ReceiveGainablesEffect(new FaithPointsTrack(10)), new ReceiveGainablesEffect(new VictoryPoint(5))));
